        ...
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <a data-rel="prettyphoto" href="resources/images/products/example.jpg">
                    <img class="img-responsive" src="resources/images/blank.gif" data-echo="resources/images/products/example.jpg" />
                </a>
            </div>
        </div>
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div id="owl-single-product-thumbnails">
                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="0" href="#slide1">
                    <img width="67" alt="" src="resources/images/blank.gif" data-echo="resources/images/products/example.jpg" />
                </a>
