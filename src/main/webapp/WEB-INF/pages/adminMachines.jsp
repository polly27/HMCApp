...
<c:forEach items="${machineList}" var="machine" varStatus="loop">
    <div class="row-machine hidden" id="item${loop.index + 1}">
        ...
        <form:form id="form${machine.productId}" class="hidden formBox"
                   action="adminMachines/edit?productId=${machine.productId}" method="post">
            <hr>
...
<div id="upload">
    <form:form class="formBox" method="post" action="adminMachines/upload"
...
<div id="filters">
    <form:form class="formBox" method="post" action="adminMachines/renewFilters">
